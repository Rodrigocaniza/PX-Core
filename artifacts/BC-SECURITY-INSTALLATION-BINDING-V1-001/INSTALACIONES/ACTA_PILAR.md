...
| | |
|---|---|
| Sucursal | **PILAR** (`--sucursal PILAR`) |
| Etiqueta de enrolamiento | `Optica PILAR - Caja 1` |
| Organizacion | `optica` |
...
| 5 | `enrolar --etiqueta "Optica PILAR - Caja 1"` | installation_id + frase mostrada una vez | | |
...
Si cualquiera de las dos casillas de aviso queda marcada: **revertir esta PC con
el paso 11 y avisar** antes de dejarla operando. Que ASUNCION haya dado DENY no
prueba nada sobre esta maquina: cada PC sella su secreto con su propio hardware.
